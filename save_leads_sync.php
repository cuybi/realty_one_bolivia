...
if (!empty($raw)) {
    ...
    if (is_array($data)) {
        ...
        if (isset($data['nombre']) || isset($data['telefono'])) {
            ...
            $nowBolivia = new DateTime('now', $tz);

            $w = (int)$nowBolivia->format('w');
            $n = (int)$nowBolivia->format('n');
            $horaBolivia = $nowBolivia->format('H:i:s');
            $fechaBolivia = $nowBolivia->format('Y-m-d');
            $fechaCreacionBolivia = $nowBolivia->format('c');
            ...
            $newLead = [
                ...
                'email' => $email,
                'fecha_creacion' => $fechaCreacionBolivia,
                'fecha_completa' => $fechaBolivia,
                'hora' => $horaBolivia,
                'dia' => $nowBolivia->format('d'),
                'dia_semana' => $dias[$w],
                'mes' => $meses[$n],
                'mes_numero' => $nowBolivia->format('m'),
                'anio' => $nowBolivia->format('Y'),
